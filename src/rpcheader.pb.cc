...
const uint32_t TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::LS_RPC::RpcHeader, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::LS_RPC::RpcHeader, service_name_),
  PROTOBUF_FIELD_OFFSET(::LS_RPC::RpcHeader, method_name_),
  PROTOBUF_FIELD_OFFSET(::LS_RPC::RpcHeader, args_size_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::LS_RPC::RpcHeader)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::LS_RPC::_RpcHeader_default_instance_),
};

const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\006LS_RPC\"I\n\tRpcHeader\022\024"
...
RpcHeader::RpcHeader(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:LS_RPC.RpcHeader)
}
RpcHeader::RpcHeader(const RpcHeader& from)
  ...
  // @@protoc_insertion_point(copy_constructor:LS_RPC.RpcHeader)
}
...
RpcHeader::~RpcHeader() {
  // @@protoc_insertion_point(destructor:LS_RPC.RpcHeader)
...
// @@protoc_insertion_point(message_clear_start:LS_RPC.RpcHeader)
...
uint8_t* RpcHeader::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:LS_RPC.RpcHeader)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:LS_RPC.RpcHeader)
  return target;
}

size_t RpcHeader::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:LS_RPC.RpcHeader)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:LS_RPC.RpcHeader)
...
// @@protoc_insertion_point(class_specific_copy_from_start:LS_RPC.RpcHeader)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::LS_RPC::RpcHeader* Arena::CreateMaybeMessage< ::LS_RPC::RpcHeader >(Arena* arena) {
  return Arena::CreateMessageInternal< ::LS_RPC::RpcHeader >(arena);
}
